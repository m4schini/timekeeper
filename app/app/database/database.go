...
type Queries interface {
	...
	GetTimeslotsOfEvent(event int, roles []model.Role, offset int, limit int) (ts []model.TimeslotModel, total int, err error)
...
type Commands interface {
	...
	UpdateRoom(m model.UpdateRoomModel) (err error)
